...
export class CreateAndSeedMedication1712345678902 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      VALUES
        ('Aspirin', 50, 'ASPIRIN01', 'aspirin_image_url', 'DRN_1X92L'),
        ('Paracetamol', 100, 'PARA100', 'paracetamol_image_url', 'DRN_5T43M'),
        ('Ibuprofen', 200, 'IBU200', 'ibuprofen_image_url', 'DRN_9K76H'),
        ('Amoxicillin', 150, 'AMOX150', 'amoxicillin_image_url', 'DRN_3P29C'),
        ('Ciprofloxacin', 120, 'CIPRO120', 'ciprofloxacin_image_url', 'DRN_7R82L');
    `);
  }
